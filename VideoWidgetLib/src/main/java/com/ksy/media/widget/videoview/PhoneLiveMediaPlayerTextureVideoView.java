 ...
 */
public class PhoneLiveMediaPlayerTextureVideoView extends MediaPlayerTextureVideoView {
    public int mTargetOrientaion;
    public int mLastOrientaion;
    public int mCurrentPushMode = PhoneLiveMediaPlayerTextureVideoView.PUSH_MODE_PORTRAIT;
    ...
    public PhoneLiveMediaPlayerTextureVideoView(Context context) {
        super(context);
    }

    public PhoneLiveMediaPlayerTextureVideoView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PhoneLiveMediaPlayerTextureVideoView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onParentVideoSizeChanged() {
        if (mVideoWidth > mVideoHeight) {
            setCurrentPushMode(PhoneLiveMediaPlayerTextureVideoView.PUSH_MODE_LANDSCAPE);
        } else {
            setCurrentPushMode(PhoneLiveMediaPlayerTextureVideoView.PUSH_MODE_PORTRAIT);
        }
        if (mCurrentPushMode == PhoneLiveMediaPlayerTextureVideoView.PUSH_MODE_PORTRAIT) {
