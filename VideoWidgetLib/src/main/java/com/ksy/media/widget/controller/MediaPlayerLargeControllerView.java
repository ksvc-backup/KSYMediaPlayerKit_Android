...
public class MediaPlayerLargeControllerView extends
		...
		onScreenShowListener, OnSystemUiVisibilityChangeListener, OnItemClickListener {
...
//		Log.d(Constants.LOG_TAG, "170 mContext =" + relationList + ">>relationList=" + relationList);
		...
		mRelateListview.setOnItemClickListener(this);
...
//			show();
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		Toast.makeText(mContext.getApplicationContext(), "related video clicked", Toast.LENGTH_SHORT).show();
	}
