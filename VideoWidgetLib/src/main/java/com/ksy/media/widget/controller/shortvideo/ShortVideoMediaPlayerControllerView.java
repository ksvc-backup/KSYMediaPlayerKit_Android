...
public class ShortVideoMediaPlayerControllerView extends MediaPlayerBaseControllerView implements View.OnClickListener {
    ...
    @Override
    public void onShow() {
        ((IShortVideoController)mMediaPlayerController).onControllerShow(MediaPlayMode.PLAY_MODE_WINDOW);
    ...
    @Override
    public void onHide() {
        ((IShortVideoController)mMediaPlayerController).onControllerHide(MediaPlayMode.PLAY_MODE_WINDOW);
